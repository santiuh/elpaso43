  ...
  <div class="lg:px-52 py-10 flex flex-col">
    <div class="text-center lg:text-start">
      ...
      <p class="font-monse text-2xl">
        Consultá los días disponibles y contactanos para reservar ahora tu lugar
        en El Paso 43.
      </p>
    </div>
    <!-- ARRANCA -->
    <div class="flex flex-row justify-center my-10">
      ...
      <div class="flex flex-row">
        ...
        <div class="flex flex-col">
          ...
          <div class="border max-w-fit lg:p-2">
            <div
              v-for="habitacion in habitaciones"
            ...
            >
              <div style="display: flex">
                <button
                  v-for="dia in dias"
                  :key="`${habitacion}-${dia}`"
                  class="border border-gray-300 lg:min-w-[2rem] text-center lg:px-1"
